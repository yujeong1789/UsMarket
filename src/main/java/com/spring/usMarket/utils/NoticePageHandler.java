...
public class NoticePageHandler {
	...
	private NoticeSearchCondition sc; // page, pageSize, option
    ...
    public NoticePageHandler(int totalCnt, NoticeSearchCondition sc) {
    ...
    public void doPaging(int totalCnt, NoticeSearchCondition sc) {
        this.totalCnt = totalCnt;
        this.sc=sc;
	...
	public NoticeSearchCondition getSc() {
		return sc;
	}

	public void setSc(NoticeSearchCondition sc) {
		this.sc = sc;
	}
