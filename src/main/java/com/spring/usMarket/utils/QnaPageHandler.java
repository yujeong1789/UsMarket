...
public class QnaPageHandler {

	private QnaSearchCondition sc; // page, pageSize, member_no
private int totalCnt;
    ...
    public QnaPageHandler(int totalCnt, QnaSearchCondition sc) {
    ...
    public void doPaging(int totalCnt, QnaSearchCondition sc) {
        this.totalCnt = totalCnt;
        this.sc=sc;
	...
	public QnaSearchCondition getSc() {
		return sc;
	}

	public void setSc(QnaSearchCondition sc) {
		this.sc = sc;
	}
