...
public class AdminPageHandler {
	...
	private AdminSearchCondition sc; // page, pageSize, option
    ...
    public AdminPageHandler(int totalCnt, AdminSearchCondition sc) {
    ...
    public void doPaging(int totalCnt, AdminSearchCondition sc) {
        this.totalCnt = totalCnt;
        this.sc=sc;
	...
	public AdminSearchCondition getSc() {
		return sc;
	}

	public void setSc(AdminSearchCondition sc) {
		this.sc = sc;
	}
